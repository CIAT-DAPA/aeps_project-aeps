    ...
    jQuery.fn.pwdMeter = function(options) {
        ...
        return this.each(function(index) {
            ...
            function evaluateMeter() {
                ...
                $('#pwdMeter').removeClass("progress-bar-success progress-bar-warning progress-bar-danger");

                switch (passwordStrength) {
                    case 1:
                        $('#pwdMeter').addClass('progress-bar-danger');
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        $('#pwdMeter').addClass('progress-bar-warning');
                        $('#pwdMeter .bar').width('50%');
                        $('#pwdMeter .pwdText').text(options.mediumText);
                        break;
                    case 4:
                        $('#pwdMeter').addClass('progress-bar-success');

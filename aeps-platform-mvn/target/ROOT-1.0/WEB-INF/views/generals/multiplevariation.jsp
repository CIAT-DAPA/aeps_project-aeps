    ...
    <body>     
        ...
        <div class="container">
            <ul id="breadcrumbs">
                ...
                <li><span><s:property value="getText('label.multiplevariation')" /></span></li>
            </ul>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <iframe src="http://www.open-aeps.org:3838/App-Multiple/" class="col-xs-12 col-sm-12 col-md-12" style="height: 600px;"></iframe>
                </div>
            </div>
        </div>
    </body>

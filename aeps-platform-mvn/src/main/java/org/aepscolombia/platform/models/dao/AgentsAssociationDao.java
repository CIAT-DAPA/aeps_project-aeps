...
/**
 * Clase AgentsAssociationDao
 *
 * Contiene los metodos para interactuar con la tabla AgentsAssociation de la base de datos (BD)
 *
 * @author Juan Felipe Rodriguez
 * @version 1.0
 */
public class AgentsAssociationDao {

//    public AgentsAssociation checkEntityIdent(String typeIdent, String ident) {
//        SessionFactory sessions = HibernateUtil.getSessionFactory();
//        Session session = sessions.openSession();
//
//        AgentsAssociation event = null;
//        Transaction tx = null;
//        String sql = "";
//
...
//            Query query = session.createSQLQuery(sql).addEntity("usr", AgentsAssociation.class);
//            event = (AgentsAssociation)query.uniqueResult();
//            tx.commit();
...
//        Session session = sessions.openSession();
//
//        AgentsAssociationTypes event = null;
//        Transaction tx = null;
//        String sql = "";
//        String valEntity = "";
//
...
//        try {
//            tx = session.beginTransaction();
//            Query query = session.createSQLQuery(sql).addEntity("entTy", AgentsAssociationTypes.class);
//            event = (AgentsAssociationTypes)query.uniqueResult();
...
//    }
//    
//    public AgentsAssociation findById(Integer id) {
//        SessionFactory sessions = HibernateUtil.getSessionFactory();
//        Session session = sessions.openSession();
//
//        AgentsAssociation event = null;
...
//        try {
//            tx = session.beginTransaction();
//            String hql  = "FROM AgentsAssociation E WHERE E.idEnt = :id_ent";
...
//    }
//
//    public List<AgentsAssociation> findAll() {
//        SessionFactory sessions = HibernateUtil.getSessionFactory();
//        Session session = sessions.openSession();
//        List<AgentsAssociation> events = null;
//        Transaction tx = null;
//        try {
//            tx = session.beginTransaction();
//            Query query = session.createQuery("from AgentsAssociation");
//            events = query.list();
//            tx.commit();
//        } catch (HibernateException e) {
//            if (tx != null) {
...
//    }
//
//    public void save(AgentsAssociation event) throws HibernateException {
//        SessionFactory sessions = HibernateUtil.getSessionFactory();
//        Session session = sessions.openSession();
//
//        Transaction tx = null;
...
//    }
//
//    public void delete(AgentsAssociation event) {
//        SessionFactory sessions = HibernateUtil.getSessionFactory();
//        Session session = sessions.openSession();
//
//        Transaction tx = null;
